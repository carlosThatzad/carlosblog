        ...
        <div class="col-md-8 col-md-offset-2 col-lg-12" >
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title" style="color:white;margin-top:5px;">Nuevo Articulo</h3>
                </div>
                <div class="panel-body">
                    <div class="table-container">
                        <form method="POST" action="{{ route('articulo.store') }}"  role="form">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-12 mt-5">
                            ...
                            <div class="form-group col-lg-12 mt-5 align-items-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-12 mt-5">
                                    <div class="form-group">
                                        <input type="file" name="imagen" id="imagen" class="form-control input-sm" placeholder="imagen">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-12 mt-5">
